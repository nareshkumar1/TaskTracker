			...
			<form id="employeeForm">
				<div class="input-group">
					<table style='margin-left: 200px'>
						...
						<tr>
							<td><input type='text' name='userFullName' id='userFullName'
								class='form-control' placeholder="Full Name" /></td>
						</tr>		
						...
						<tr style='height: 70px'>
							<td><g:select id='depts'
									class="dropdown-toggle form-control" data-toggle="dropdown"
									name="deptName" noSelection="${['':'Select Department']}"
									from="${dept?.departmentName}" /></td>
						</tr>
						<tr>
							<td><g:select id='roles'
									class="dropdown-toggle form-control" data-toggle="dropdown"
									name="roleName" noSelection="${['':'Select Role']}"
									from="${role?.role}" /></td>
						</tr>
						<tr style='height: 70px'>
							<td><input type='button' id='saveButton' value='Submit'
								class='bigButton shadowBox btn btn-info btn-lg'></td>
						</tr>
					</table>
				</div>
			</form>
